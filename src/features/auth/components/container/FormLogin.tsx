...
export const FormLogin: React.FC<InputContainerProps> = ({
  focused,
  handleBlur,
  handleFocused,
}) => {
  const [, setFormState] = useState<AuthFormState>(initialFormState);
  ...
  return (
    <View style={style.form}>
      ...
      <GloButton onPress={handleSubmit} title="Login" size="sm" />
      <GloButton
        onPress={() => handleNavigate('register-screen')}
        title="Register"
        size="sm"
        variant="primary"
      />
